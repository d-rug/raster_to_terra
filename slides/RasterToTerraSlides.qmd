...
## More Speed, Fewer Details

Structure of a `spatRaster` object:

```{r under_the_hood, echo=TRUE}

str(elev) # spatRaster

```

Structure of a `RasterLayer` object:

```{r under_the_hood2, echo=TRUE}

head(str(r_elev)) # rasterLayer
